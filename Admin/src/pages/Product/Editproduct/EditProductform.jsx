  ...
  initialValues={{
    ...
    model3D: data?.data?.model3D || "",
        ...
        onSubmit={(values) => {
          ...
          if (values.model3D && values.model3D !== data.data.model3D) {
...
{/* glb file code */}
  ...
  <div className="row">
    <div className="col-lg-4">
      <label htmlFor="model3D" className="form-label">
        Upload 3D Model (GLB)
      </label>
    </div>
    <div className="col-lg-8">
      <input
        ...
        accept=".glb"
        className="form-control"
        onChange={(e) => setFieldValue("model3D", e.currentTarget.files[0])}
      />
      {data?.data?.model3D && (
        <a
          href={data.data.model3D}
          target="_blank"
          rel="noopener noreferrer"
          style={{ fontSize: "12px" }}
        >
          Current File: {data.data.model3D.split("/").pop()}
        </a>
      )}
    </div>
  </div>
          ...
          <div className="col-3">
            ...
            <img
              ...
              <div class="card__content">
                ...
                <p class="card__description" style={{color:'black'}}>PKR{item.selling_price} <span style={{textDecoration:'line-through',fontSize:'11px'}}>PKR{item.mrp_price}</span></p>
