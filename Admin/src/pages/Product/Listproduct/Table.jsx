...
// glb file have or have not
    {
      ...
      align: "center",
      flex: 0.6,
      renderCell: ({ row: { model3D } }) => {
        return model3D ? "Yes" : "No";
      }
    },
  ...
  const deleteproduct = async () => {
    try {
      const res = await deletereord(isdelete).unwrap(); // .unwrap() gives the actual response data
  
      // ✅ Filter the deleted product out of the state
  ...
  // fetch all product api staart here
