...
setTimeout(() => {
                        ...
                        <tbody>
                          <tr>
                            <td width="49%"><strong>Company Name :</strong>{websiteinfo.data[0].website_name}<br />
                              <strong>Address:</strong>{websiteinfo.data[0].address} <br />
  ...
  const price = rescart.product_id == null
    ? rescart.product_variant_id?.selling_price ?? "N/A"
    : rescart.product_id?.selling_price ?? "N/A";

  const total = (price === "N/A" ? 0 : price * rescart.product_qty);

  return (
    <tr key={rescart._id || index}>
      <td
        width="5%"
        height="24"
        align="center"
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td width="20%" valign="top" style={{ padding: '8px 6px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '12px',display:'flex',justifyContent:'space-between' }}>
                              <strong>Sub Total :</strong> {orderdetail.data.sub_total_amount} Pkr
                            </td>
                          </tr>
                      ...
                      <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                        <tbody>
                          ...
                          <tr style={{borderTop:'1px solid black'}}>
                            <td width="20%" valign="top" style={{ padding: '8px 6px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '12px',display:'flex',justifyContent:'space-between' }}>
                              <strong>Shipping Charges :</strong> {orderdetail.data.shipping_charges} Pkr
                            </td>
                          </tr>
                    ...
                    <td>
                      <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                        <tbody>
                          ...
                          <tr style={{borderTop:'1px solid black'}}>
                            <td width="20%" valign="top" style={{ padding: '8px 6px', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '12px',display:'flex',justifyContent:'space-between' }}>
                              <strong>Grand Total :</strong> {orderdetail.data.grand_total_amount} Pkr
                            </td>
                          </tr>
