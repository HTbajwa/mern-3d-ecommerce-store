          ...
          <table className="table">
            ...
            <tbody>
              <tr>
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px"}}>PKR63.00</h6></td>
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px", color: '#059fe2'}}>PKR539.00</h6></td>
                <td>
              ...
              <tr>
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px"}}>PKR243.00</h6></td>
                <td>  <div className="qty-box" style={{padding: '10px 0px'}}>
                    <div className="input-group qtywidth">
                      <button style={{border: 'none', outline: 'none', backgroundColor: 'white', color: '#059fe2', fontSize: "17px", fontWeight: 700}}>-</button>
                      <input type="number" name="quantity" style={{width:"40px"}} className="form-control qty input-number" defaultValue={1} />
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px", color: '#059fe2'}}>PKR6539.00</h6></td>
                <td> 
                  {/* <a href="javascript:void(0)" class="icon" style="color:#777777;padding: 0px 3px; line-height: 63px;"> <img src="/images/edit.png" alt="404"> </a> */}
                  <a href="javascript:void(0)" className="icon" style={{color: '#777777', padding: '0px 3px', lineHeight: "63px"}}><img src="/images/delete.png" alt={404} /></a></td>
              </tr>
              <tr>
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px"}}>PKR93.00</h6></td>
                <td>  <div className="qty-box" style={{padding: '10px 0px'}}>
                    <div className="input-group qtywidth">
                      <button style={{border: 'none', outline: 'none', backgroundColor: 'white', color: '#059fe2', fontSize: "17px", fontWeight: 700}}>-</button>
                      <input type="number" name="quantity" style={{width:"40px"}} className="form-control qty input-number" defaultValue={1} />
                ...
                <td><h6 className="td-color" style={{fontWeight: 400, lineHeight: "63px",fontSize:"14px", color: '#059fe2'}}>PKR1539.00</h6></td>
                <td> 
                  {/* <a href="javascript:void(0)" class="icon" style="color:#777777;padding: 0px 3px; line-height: 63px;"> <img src="/images/edit.png" alt="404"> </a> */}
                  <a href="javascript:void(0)" className="icon" style={{color: '#777777', padding: '0px 3px', lineHeight: "63px"}}><img src="/images/delete.png" alt={404} /></a></td>
              </tr>
      ...
      <div className="col-md-4 mt-lg-0 mt-md-0 mt-sm-3 mt-xs-3">
        <div className="py-2 px-2" style={{background: '#ffff', borderRadius: 6}}>
          ...
          <div className="firstrow px-3 d-flex justify-content-between" style={{padding:"5px 0px"}}>
            ...
            <span className="family" style={{fontWeight: 500, color: '#059fe2',fontSize:'12px'}}>PKR3000.00</span>
          </div>
          <div className="firstrow px-3 d-flex justify-content-between" style={{padding:"5px 0px"}}>
            <span className="family" style={{fontWeight: 600, fontSize: "12px"}}>Discount</span>
            <span className="family" style={{fontWeight: 500, color: '#059fe2',fontSize:'12px'}}>- PKR100.00</span>
          </div>
          <div className="firstrow px-3 d-flex justify-content-between" style={{padding:"5px 0px"}}>
            <span className="family" style={{fontWeight: 600, fontSize: "12px"}}>Shipping</span>
            <span className="family" style={{fontWeight: 500, color: '#059fe2',fontSize:'12px'}}>PKR500.00</span>
          </div>
          <div className="firstrow px-3 d-flex justify-content-between" style={{padding:"5px 0px"}}>
          ...
          <div className="firstrow px-2 mx-2 py-1 d-flex justify-content-between mt-1 align-items-center">
            <div className="firstcontianer d-flex align-items-start" style={{gap: 4}}>
              ...
              <div>
                ...
                <p className="m-0" style={{color: '#8F9091',fontSize:"10px"}}>- PKR250.00 (10% off)</p>
              </div>
            </div>
          ...
          <div className="firstrow px-2 d-flex justify-content-between" style={{padding:"5px 0px"}}>
            ...
            <span style={{fontWeight: 500, color: '#059fe2',fontSize:"12px"}}>PKR500.00   <hr color="red" style={{margin: 0, position: 'relative', top: 4, opacity: 1, color: '#2B2A29', background: '#2B2A29'}} />
</span>
          </div>
          <div className="firstrow px-2 pt-1 d-flex justify-content-between">
            <span style={{fontWeight: 600, fontSize: "12px"}}>Order Total <span  style={{fontSize: 10, color: '#8F9091',cursor:'pointer'}} onClick={()=>{setshowtax(!showtax)}} >(incl. taxes) + <br /> <span style={{fontSize: 10, color: '#8F9091', display: showtax == true ? "block" : 'none'}} id="span2">% GST on PKR1982.00</span></span>
</span>
            <span style={{fontWeight: 500, color: '#059fe2',fontSize:"12px"}}>PKR2000.00</span>
          </div>
          <div className="firstrow px-2 d-flex justify-content-between" style={{padding:"5px 0px"}}>
        ...
        <div className="py-2" style={{background: '#ffff', borderRadius: 6, marginTop: 10}}>
          ...
          <div className="firstrow px-3 pb-2 d-flex justify-content-between">
            <span style={{fontWeight: 600, fontSize: "17px"}} />
            <span style={{fontWeight: 500, fontSize: 11}}>Available Credit - PKR5000</span>
          </div>
        </div>
      </div>
    </div>
