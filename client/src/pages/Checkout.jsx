                                ...
                                {cartdata.data[0]?.product_name
                                  ? cartdata.data.map((item, index) => (
                                    ...
                                    <span style={{ fontSize: "12px" }}>
                                      PKR{item.product_variant_id.selling_price * item.product_qty}
                                    </span>
                                  </li> : <li style={{ fontSize: "12px" }}>
                                        {item.product_id.product_name} × {item.product_qty}{" "}
                                        <span style={{ fontSize: "12px" }}>
                                          PKR{item.product_id.selling_price * item.product_qty}
                                        </span>
                                      </li>
                                    ))
                                  : ""}
                              ...
                              <ul className="sub-total">
                                <li style={{ fontSize: "12px" }}>
                                  ...
                                  <span
                                    ...
                                    className="count"
                                  >
                                    PKR{cartdata.total_Amount_with_discount_subtotal}
                                  </span>
                                </li>
                                <li style={{ fontSize: "12px" }}>
                                  Shipping{" "}
                                  ...
                                  >
                                    {/* PKR{0.0} */}
                    PKR{cartdata.shipping_charges == 0 ? `0.00` : cartdata.shipping_charges}
                              ...
                              <ul className="total">
                                <li>
                                  ...
                                  <span
                                    ...
                                    className="count"
                                  >
                                    PKR{cartdata.total_Amount_with_discount}
                                  </span>
                                </li>
                              </ul>
                            </div>
