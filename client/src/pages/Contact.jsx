        ...
        <div className="info-column col-md-4 col-sm-12 col-xs-12">
          <div className="inner-column">
            ...
            <ul className="list-info">
              <li><i className="fas fa-globe" />University of Sargodha.</li>
              <li><i className="far fa-envelope" />hadiabajwa930@gmail.com</li>
              <li><i className="fas fa-phone" />03187597351<br /></li>
            </ul>
