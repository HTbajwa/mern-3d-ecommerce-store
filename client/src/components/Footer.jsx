            ...
            <div className="footer-box">
              ...
              <div className="footer-contant">
                <div className="footer-logo">
                  <NavLink href="/Home">
                    <img src={`/images/Ecomus.svg`} className="maxwidthlogo" alt="logo" />
                  </NavLink>
                </div>
                ...
                {/* <ul className="paymant">
                  <li>
                    <a href="javascript:void(0)"><img src={`/images/layout-1/pay/1.png`} className="img-fluid" alt="pay" /></a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"><img src={`/images/layout-1/pay/2.png`} className="img-fluid" alt="pay" /></a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"><img src={`/images/layout-1/pay/3.png`} className="img-fluid" alt="pay" /></a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"><img src={`/images/layout-1/pay/4.png`} className="img-fluid" alt="pay" /></a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"><img src={`/images/layout-1/pay/5.png`} className="img-fluid" alt="pay" /></a>
                  </li>
                </ul> */}
              </div>
            </div>
            ...
            <div className="footer-box">
              ...
              <div className="footer-contant">
                <ul>
                  ...
                  <a href="" style={{position: 'relative', background: 'white',borderRadius: '50%', color: '"white"', padding: '0px 0px', display: 'flex', justifyContent: 'start', alignItems: 'center'}}><i style={{position: 'relative', color: '#059fe2'}} className="fa-brands fa-instagram" /> &nbsp; Instagram</a>

                  </li>
                  <li>
                    {/* <NavLink to="/privacypolicy">Privacy Policy</NavLink> */}
                  <a href="" style={{position: 'relative', background: 'white',borderRadius: '50%', color: '"white"', padding: '0px 0px', display: 'flex', justifyContent: 'start', alignItems: 'center'}}><i style={{position: 'relative', color: '#059fe2'}} className="fa-brands fa-youtube" /> &nbsp; You Tube</a>

                    </li>
                  <li>
                    {/* <NavLink to="/termsconditions">Terms & Conditions</NavLink> */}
                  <a href="" style={{position: 'relative', background: 'white',borderRadius: '50%', color: '"white"', padding: '0px 0px', display: 'flex', justifyContent: 'start', alignItems: 'center'}}><i style={{position: 'relative', color: '#059fe2'}} className="fa-brands fa-linkedin" /> &nbsp; Linkedin</a>
            ...
            <div className="footer-box">
              ...
              <div className="footer-contant">
                <ul className="contact-list">
                  <li>
                    <i className="fa fa-map-marker" />University 
                    of
                    <br />
                    Sargodha
 -<span>40100</span>
                  ...
                  {/* <li>
                    <div style={{display: 'flex', gap: 6, position: 'relative', alignItems: 'center'}}>
                      ...
                      <div style={{display: 'flex', gap: 5}}>
                        <a href="" style={{position: 'relative', background: '#4150b5', borderRadius: '50%', color: '"white"', padding: '7px 10px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}><i style={{position: 'relative', color: 'white'}} className="fa-brands fa-facebook-f" /></a>
